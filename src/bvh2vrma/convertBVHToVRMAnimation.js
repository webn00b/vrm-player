...
export function convertBVHToVRMAnimation(bvh, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        // Auto-detect scale: centimeter-based BVH (Mixamo raw) have skeleton height > 5, meters-based have < 5
        const autoScale = (() => { const b = new THREE.Box3(); const v = new THREE.Vector3(); bvh.skeleton.bones.forEach(bone => b.expandByPoint(bone.getWorldPosition(v))); return (b.max.y - b.min.y) > 5 ? 0.01 : 1.0; })();
        const scale = (_a = options === null || options === void 0 ? void 0 : options.scale) !== null && _a !== void 0 ? _a : autoScale;
