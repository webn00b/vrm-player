 ...
 *
 * The CoM hip balancers (translation + rotation) used to live here too;
 * they were moved into the Capture panel's "Conversion settings" fold
 * (CaptureConvertSettings.vue) where the pose-conversion knobs are tuned.
 *
